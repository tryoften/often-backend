...
declare module "restler" {
	...
	export function json(url: string, data: any, options: RequestOptions);

	// Send json data via POST method.
	export function postJson(url: string, data: any, options: RequestOptions);

	// Send json data via PUT method.
	export function putJson(url: string, data: any, options: RequestOptions);

	// Send json data via PATCH method.
	export function patchJson(url: string, data: any, options: RequestOptions);
