...
var CachedResultsManager = (function (_Firebase$Model) {
	function CachedResultsManager() {
		_classCallCheck(this, CachedResultsManager);
	...
	_inherits(CachedResultsManager, _Firebase$Model);
	...
	_createClass(CachedResultsManager, [{
		...
		get: function (query, providerId) {
			return this.get(query)[providerId].meta.time_completed;
		}
	}, {
		key: 'hasProviderResult',
		get: function (query, providerId) {
			return this.get(query)[providerId] != null;
		}
	}, {
		key: 'providerResult',
		get: function (query, providerId) {
...
//# sourceMappingURL=CachedResult.js.map